...
class ArCoreFaceView(activity:Activity,context: Context, messenger: BinaryMessenger, id: Int, debug: Boolean) : Base2ArCoreView(activity, context, messenger, id, debug) {
